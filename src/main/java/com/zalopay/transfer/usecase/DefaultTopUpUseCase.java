...
public class DefaultTopUpUseCase implements TopUpUseCase {
    ...
    private List<TransferInfo> initStepTransfer(Transaction transaction, TopUpRequest request) {
    ...
    private Transaction initTransaction(TopUpRequest request) {
        ...
        transaction.setTransType(TransType.TOP_UP);
